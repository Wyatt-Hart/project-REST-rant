                ...
                <form method='POST' action={`/places/${data.id}?_method=PUT`} style={{textAlign: 'center'}}>
                    <div className='row' style={{margin: '2vw', marginTop: '3vh'}}>
                        ...
                        <div className='form-group col-sm-6 col-md-4 col-lg-3'style={{marginTop: '3vh'}}>
                                ...
                                <input className='form-control' type={'url'} id='website' name='website' defaultValue={data.place.website}/>
                        </div>
                        <div className='form-group col-sm-6 col-md-4 col-lg-3'style={{marginTop: '3vh'}}>

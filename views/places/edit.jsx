        ...
        <Def>
            <main>
                ...
                <form method='POST' action={`/places/${data.id}?_method=PUT`} style={{textAlign: 'center'}}>
					...
					<div className='form-group' style={{display: 'inline-block', width: '50vw'}}>
						<label htmlFor='cuisines'>Cuisines</label>
						<input className='form-control' id='cuisines' name='cuisines' value={data.place.cuisines} required/>
					</div>
					<input className='btn btn-primary' type={'submit'} value={'Add Place'} style={{display: 'flex', margin: 'auto'}} />
				</form>
            </main>
        </Def>
    )
